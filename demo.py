...
def get_args():
    ...
    parser.add_argument('--project_name', default='test2', type=str)
    parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--checkpoint_root', default='checkpoints2', type=str)
    parser.add_argument('--output_folder', default='../BIT_data2/predict', type=str)
